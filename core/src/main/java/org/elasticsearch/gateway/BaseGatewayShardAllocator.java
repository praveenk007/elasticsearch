...
public abstract class BaseGatewayShardAllocator extends AbstractComponent {
    ...
    public void allocateUnassigned(RoutingAllocation allocation) {
        System.out.println(LocalDateTime.now() + "BaseGatewayShardAllocator -> allocateUnassigned n59 " + this.getClass());
        ...
        while (unassignedIterator.hasNext()) {
            ...
            System.out.println(LocalDateTime.now() + " BaseGatewayShardAllocator n65 receive allocateUnassignedDecision:" + allocateUnassignedDecision.getAllocationDecision());
    ...
    protected List<NodeAllocationResult> buildDecisionsForAllNodes(ShardRouting shard, RoutingAllocation allocation) {
        System.out.println(LocalDateTime.now() + " BaseGatewayShardAllocator -> buildDecisionsForAllNodes n102 " + this.getClass());
