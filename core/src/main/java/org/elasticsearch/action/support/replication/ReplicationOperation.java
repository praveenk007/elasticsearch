...
public class ReplicationOperation<
    ...
    public void execute() throws Exception {
        System.out.println(LocalDateTime.now() + " ReplicationOperation -> execute n103 " + this.getClass());
        ...
        System.out.println(LocalDateTime.now() + " ReplicationOperation -> perform n115 " + this.getClass());
        primaryResult = primary.perform(request);
        System.out.println("ReplicationOperation得到结果，结果为：" + primaryResult);
        ...
        if (replicaRequest != null) {
            ...
            System.out.println("开始写入副本。。。");
            performOnReplicas(replicaRequest, shards);
            System.out.println("写入副本完毕");
        }
    ...
    private void performOnReplicas(ReplicaRequest replicaRequest, List<ShardRouting> shards) {
        System.out.println(LocalDateTime.now() + " ReplicationOperation -> performOnReplicas n165 " + this.getClass());
    ...
    private void performOnReplica(final ShardRouting shard, final ReplicaRequest replicaRequest) {
        ...
        System.out.println(LocalDateTime.now() + " ReplicationOperation -> performOnReplica n191 " + this.getClass());
        totalShards.incrementAndGet();
        pendingActions.incrementAndGet();
