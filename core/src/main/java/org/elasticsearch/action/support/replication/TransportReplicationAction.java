...
public abstract class TransportReplicationAction<
    ...
    protected void doExecute(Task task, Request request, ActionListener<Response> listener) {
        System.out.println(LocalDateTime.now() + " TransportReplicationAction -> doExecute n137 " + this.getClass());
    ...
    class PrimaryOperationTransportHandler implements TransportRequestHandler<ConcreteShardRequest<Request>> {
        ...
        public void messageReceived(ConcreteShardRequest<Request> request, TransportChannel channel, Task task) {
            System.out.println(LocalDateTime.now() + " TransportReplicationAction -> messageReceived n250 " + this.getClass());
    ...
    final class ReroutePhase extends AbstractRunnable {
        ...
        protected void doRun() {
            System.out.println(LocalDateTime.now() + " TransportReplicationAction -> doRun n622 " + this.getClass());
        ...
        private void performLocalAction(ClusterState state, ShardRouting primary, DiscoveryNode node) {
            ...
            System.out.println(LocalDateTime.now() + " TransportReplicationAction -> performLocalAction n663 " + this.getClass());
    ...
    private void acquirePrimaryShardReference(ShardId shardId, String allocationId,
        ...
        System.out.println(LocalDateTime.now() + " TransportReplicationOperation -> acquirePrimaryShardReference n866 " + this.getClass());
