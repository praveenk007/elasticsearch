...
public abstract class TransportMasterNodeAction<Request extends MasterNodeRequest<Request>, Response extends ActionResponse> extends HandledTransportAction<Request, Response> {
    ...
    protected void doExecute(Task task, final Request request, ActionListener<Response> listener) {
        System.out.println(LocalDateTime.now() + " TransportMasterNodeAction ->  doExecute n105 " + this.getClass());
    ...
    class AsyncSingleAction {
        ...
        public void start() {
            System.out.println(LocalDateTime.now() + " TransportMasterNodeAction ->  AsyncSingleAction start n126 " + this.getClass());
