...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    public WritePrimaryResult<BulkShardRequest, BulkShardResponse> shardOperationOnPrimary(
        ...
        System.out.println(LocalDateTime.now() + " TransportShardBulkAction -> shardOperationOnPrimary n108 " + this.getClass());
        ...
        System.out.println("TransportShardBulkAction 所有数据在主分片上写入操作完成，返回结果");
    ...
    private Translog.Location executeBulkItemRequest(IndexMetaData metaData, IndexShard primary,
        ...
        System.out.println(LocalDateTime.now() + " TransportShardBulkAction -> executeBulkItemRequest n132 " + this.getClass());
        ...
        try {
            ...
            if (operationResult == null) { // in case of noop update operation
                ...
                System.out.println(LocalDateTime.now() + " TransportShardBulkAction -> executeBulkItemRequest n195 " + this.getClass());
    ...
    static Engine.Index prepareIndexOperationOnPrimary(IndexRequest request, IndexShard primary) {
        System.out.println(LocalDateTime.now() + " TransportShardBulkAction -> prepareIndexOperationOnPrimary n447  TransportShardBulkAction" );
        SourceToParse sourceToParse =
