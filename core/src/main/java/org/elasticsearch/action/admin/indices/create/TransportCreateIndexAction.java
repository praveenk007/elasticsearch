...
public class TransportCreateIndexAction extends TransportMasterNodeAction<CreateIndexRequest, CreateIndexResponse> {
    ...
    protected void masterOperation(final CreateIndexRequest request, final ClusterState state, final ActionListener<CreateIndexResponse> listener) {
        System.out.println(LocalDateTime.now() + " TransportCreateIndexAction -> masterOperation n71 " + this.getClass());
        ...
        System.out.println(LocalDateTime.now() + " TransportCreateIndexAction -> masterOperation n82 " + this.getClass());
