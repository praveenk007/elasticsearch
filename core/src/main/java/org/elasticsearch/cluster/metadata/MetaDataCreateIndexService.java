...
public class MetaDataCreateIndexService extends AbstractComponent {
    ...
    public void createIndex(final CreateIndexClusterStateUpdateRequest request,
        ...
        System.out.println(LocalDateTime.now() + " MetaDataCreateIndexService -> createIndex n202 " + this.getClass());
    ...
    private void onlyCreateIndex(final CreateIndexClusterStateUpdateRequest request,
        ...
        System.out.println(LocalDateTime.now() + " MetaDataCreateIndexService -> clusterService submitStateUpdateTask n226 " + this.getClass());
                ...
                new AckedClusterStateUpdateTask<ClusterStateUpdateResponse>(Priority.URGENT, request,
                    ...
                    public ClusterState execute(ClusterState currentState) throws Exception {
                        ...
                        try {
                            ...
                            System.out.println("读取mapping参数");
                            ...
                            System.out.println("应用模板，合并mapping");
                            ...
                            System.out.println("读取索引的Settings配置参数");
                            ...
                            System.out.println("Settings构建完毕，Settings=" +  actualIndexSettings);
                            ...
                            System.out.println("开始创建索引（IndexService对象）。。。");
                            final IndexService indexService = indicesService.createIndex(tmpImd, Collections.emptyList());
                            createdIndex = indexService.index();
                            // now add the mappings
                            MapperService mapperService = indexService.mapperService();
                            try {
                                System.out.println("mapperService.merge(mappings, MergeReason.MAPPING_UPDATE, request.updateAllTypes());");
                            ...
                            System.out.println("now, update the mappings with the actual source");
                            ...
                            System.out.println("构建新的ClusterState");
                            ...
                            System.out.println("ClusterState execute(ClusterState currentState)返回新构建的ClusterState！");
                            return updatedState;
                        } finally {
                            if (createdIndex != null) {
                                System.out.println("Index was already partially created - need to clean up");
