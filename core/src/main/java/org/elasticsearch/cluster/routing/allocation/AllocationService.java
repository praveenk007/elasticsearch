...
public class AllocationService extends AbstractComponent {
    ...
    public ClusterState reroute(ClusterState clusterState, String reason) {
        System.out.println(LocalDateTime.now() + " AllocationService -> reroute n274 " + this.getClass());
    ...
    private void reroute(RoutingAllocation allocation) {
        System.out.println(LocalDateTime.now() + " AllocationService -> reroute n314 " + this.getClass());
        ...
        if (allocation.routingNodes().unassigned().size() > 0) {
            ...
            System.out.println("AllocationService gatewayAllocator.allocateUnassigned(allocation) Done!");
        }

        shardsAllocator.allocate(allocation);
        System.out.println("shardsAllocator.allocate(allocation) Done!");
