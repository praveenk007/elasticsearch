...
public class BalancedShardsAllocator extends AbstractComponent implements ShardsAllocator {
    ...
    public void allocate(RoutingAllocation allocation) {
        System.out.println(LocalDateTime.now() + " BalancedShardsAllocator -> allocate n118 " + this.getClass());
    ...
    public static class Balancer {
        ...
        private void balance() {
            System.out.println(LocalDateTime.now() + " BalancedShardsAllocator -> balance n311 " + this.getClass());
        ...
        public void moveShards() {
            System.out.println(LocalDateTime.now() + " BalancedShardsAllocator -> moveShards n645 " + this.getClass());
        ...
        private void allocateUnassigned() {
            System.out.println(LocalDateTime.now() + " BalancedShardsAllocator -> allocateUnassigned n766 " + this.getClass());
