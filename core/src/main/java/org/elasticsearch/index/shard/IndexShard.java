...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    static Engine.Index prepareIndex(DocumentMapperForType docMapper, SourceToParse source, long version, VersionType versionType,
        ...
        System.out.println(LocalDateTime.now() + " IndexShard -> prepareIndex n532 ");
    ...
    public Engine.IndexResult index(Engine.Index index) throws IOException {
        System.out.println(LocalDateTime.now() + " IndexShard index n545 " + this.getClass());
    ...
    private Engine.IndexResult index(Engine engine, Engine.Index index) throws IOException {
        System.out.println(LocalDateTime.now() + "  IndexShard index n552 " + this.getClass());
        active.set(true);
        ...
        try {
            ...
            System.out.println(LocalDateTime.now() + " IndexShard index n562 " + this.getClass());
